...
public class OracleTableFkDefinitionFileWriteCommand extends SqlFileWriteCommand {
	...
	public OracleTableFkDefinitionFileWriteCommand(Table table) {
		...
		super(table.myPackage.model.project.workspaceFolder + File.separator + DatabaseHandlerDiscovery.getBuildScriptFolder(OracleHandler.NAME, table.myPackage.model.project.projectName) + File.separator + "2" + File.separator + table.myPackage.name.toUpperCase().replace(".", File.separator), table.originalName);
