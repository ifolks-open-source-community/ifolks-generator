...
import org.ifolks.generator.components.metadata.factory.interfaces.BeanFactory;
import org.ifolks.generator.components.metadata.factory.interfaces.PackageFactory;
...
public class JavaPackageFactory implements PackageFactory {
	...
	private Package setUpPackage(PackageMetaData packageMetaData, Model model, Package parent) {
		...
		myPackage.tsModelsPath = myPackage.model.tsFeaturesPath + File.separator + "models" + File.separator + myPackage.name.replace(".", File.separator);
		myPackage.tsServicesPath = myPackage.model.tsFeaturesPath + File.separator + "services" + File.separator + myPackage.name.replace(".", File.separator);
		myPackage.tsComponentsPath = myPackage.model.tsFeaturesPath + File.separator + "components" + File.separator + myPackage.name.replace(".", File.separator);
		
		myPackage.tsModelsSourcePath = myPackage.tsModelsPath.replace(File.separator,"/");
		myPackage.tsServicesSourcePath = myPackage.tsServicesPath.replace(File.separator,"/");
		myPackage.tsComponentsSourcePath = myPackage.tsComponentsPath.replace(File.separator,"/");
