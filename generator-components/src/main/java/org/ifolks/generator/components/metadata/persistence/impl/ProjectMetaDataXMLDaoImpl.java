package org.ifolks.generator.components.metadata.persistence.impl;
...
import org.ifolks.generator.model.exception.InvalidProjectMetaDataException;
import org.ifolks.generator.model.exception.ProjectAlreadyConfiguredException;
...
public class ProjectMetaDataXMLDaoImpl implements ProjectMetaDataDao {
	...
	public void persistProjectMetaData(ProjectMetaData projectMetaData) {
		...
		try {
			...
			jaxbMarshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,"http://generator.ifolks.org/schema/model/metadata " + SCHEMA_LOCATION);
