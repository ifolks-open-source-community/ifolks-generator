...
import org.ifolks.generator.skeletons.angular.commands.pages.details.ScssDetailsComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.details.ScssOneToOneComponentDetailsComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.details.TsDetailsComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.details.TsOneToOneComponentDetailsComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.HtmlListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.HtmlOneToManyComponentListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.HtmlOneToManyListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.ScssListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.ScssOneToManyComponentListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.ScssOneToManyListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.TsListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.TsOneToManyComponentListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.list.TsOneToManyListComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.menu.HtmlMenuComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.menu.ScssMenuComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.menu.TsMenuComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.HtmlModalComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.HtmlOneToManyComponentModalComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.HtmlOneToManyModalComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.ScssModalComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.ScssOneToManyComponentModalComponentFileWriteCommand;
import org.ifolks.generator.skeletons.angular.commands.pages.modal.ScssOneToManyModalComponentFileWriteCommand;
...
public class TypeScriptComponentsLayer extends AbstractLayer {
	...
	public FileWriteCommandTreeNode getGenerationNode(Project project) {
		...
		for (Package myPackage : project.model.packages) {
			...
			FileWriteCommandTreeNode oneToOneComponentDetailsTreeNode = new FileWriteCommandTreeNode("One to one component details");
			packageTreeNode.add(oneToOneComponentDetailsTreeNode);
			for (Bean bean : myPackage.beans) {
				if (!bean.isComponent) {
					for (OneToOneComponent oneToOneComponent:bean.oneToOneComponentList) {
					
						FileWriteCommandTreeNode tsComponent = new FileWriteCommandTreeNode(new TsOneToOneComponentDetailsComponentFileWriteCommand(oneToOneComponent));
						oneToManyComponentModalsTreeNode.add(tsComponent);
						
						FileWriteCommandTreeNode scssComponent = new FileWriteCommandTreeNode(new ScssOneToOneComponentDetailsComponentFileWriteCommand(oneToOneComponent));
						oneToManyComponentModalsTreeNode.add(scssComponent);
						
						FileWriteCommandTreeNode htmlComponent = new FileWriteCommandTreeNode(new HtmlOneToOneComponentDetailsComponentFileWriteCommand(oneToOneComponent));
						oneToManyComponentModalsTreeNode.add(htmlComponent);
					}
				}
			}
